...
csar.maxLives = 99 -- Maximum pilot lives
...
csar.coordtype = 0 -- Use Lat/Long DDM (0), Lat/Long DMS (1), MGRS (2), Bullseye imperial (3) or Bullseye metric (4) for coordinates.
