...
--
--local SetCargoInfantry = SET_CARGO:New():FilterTypes( "RU_Inf_Cargo" ):FilterStart()
--local SetHelicopter = SET_GROUP:New():FilterPrefixes( "RU_Transport_Heli" ):FilterStart()
...
--      local CargoInfantry = CARGO_GROUP:New( SpawnGroup, "RU_Inf_Cargo", SpawnGroup:GetName(), 150 )
--    end
--  )
