...
ctld.pickupZones = {
    ...
    { "ChopperTarawa", "blue", -1, "yes", 0}, -- instead of a Zone Name you can also use the UNIT NAME of a ship
    { "ChopperTarawa2", "blue", -1, "yes", 0}, -- instead of a Zone Name you can also use the UNIT NAME of a ship
}
