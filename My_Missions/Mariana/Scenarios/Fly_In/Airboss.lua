...
local tanker2=RECOVERYTANKER:New("CVN-73 Carrier Strike Group-1", "ShellCarrier GW")
tanker2:SetRadio(121)
tanker2:SetModex(912)
tanker2:SetTACAN(21, "SHL11")
tanker2:SetAltitude(6000)
tanker2:SetSpeed(260)
tanker2:SetTakeoffCold()
tanker2:Start()

---- E-2D AWACS spawning on Stennis.
local awacs2=RECOVERYTANKER:New("CVN-73 Carrier Strike Group-1", "E-2D Magic GW")
awacs2:SetAWACS()
awacs2:SetRadio(251)
...
rescuehelo2=RESCUEHELO:New("CVN-73 Carrier Strike Group-1", "Rescue Helo GW")
...
local AirbossGWashington=AIRBOSS:New("CVN-73 Carrier Strike Group-1")
...
AirbossGWashington:SetRadioRelayMarshal("E-2D Magic GW")
