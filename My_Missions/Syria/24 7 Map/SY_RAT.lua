...
RU_RAT_IL76:SpawnScheduled(120,0.5):InitLimit(4,0):SpawnScheduleStart()
...
RU_RAT_AN30M:SpawnScheduled(120,0.5):InitLimit(6,0):SpawnScheduleStart()
...
RU_RAT_AN26B:SpawnScheduled(120,0.5):InitLimit(4,0):SpawnScheduleStart()
...
US_RAT_C130:SpawnScheduled(300,0.5):InitLimit(4,0):SpawnScheduleStart()
...
US_RAT_C17:SpawnScheduled(300,0.5):InitLimit(4,0):SpawnScheduleStart()
...
US_RAT_UH60:SpawnScheduled(300,0.5):InitLimit(6,0):SpawnScheduleStart()

local US_RAT_CH53 = RAT:New("US_RAT_CH53")
US_RAT_CH53:SetTakeoff("cold")
US_RAT_CH53:SetDeparture( {"US_CSG11_Tarawa","Incirlik"})
US_RAT_CH53:SetDestination( {"US_FARP_London", "US_CSG11_Tarawa" })
US_RAT_CH53:ContinueJourney()
US_RAT_CH53:SetCoalition("sameonly")
US_RAT_CH53:SpawnScheduled(300,0.5):InitLimit(6,0):SpawnScheduleStart()
