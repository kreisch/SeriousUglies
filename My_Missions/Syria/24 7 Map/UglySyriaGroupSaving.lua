...
-- Usage of this script should credit the following contributors:
 ...
 unitsListPath = "C:\\temp\\Persistence\\UglySyriaGroupSaving_24_7.lua" --edit this to represent your own (DCS cant write to different disks)
...
if file_exists(unitsListPath) then --Script has been run before, so we need to load the save
...
writemission(newMissionStr, unitsListPath)--write the file from the above to SaveUnits.lua
