...
-- Blaue Infanterie rückt auf MT01_MZ1 Zonen vor
-- Blaue Mörser müssen Moose bekannt gemacht werden
-- Rote Infanterie spawnt in den Movezonen
-- Blaue Mörser eröffnen Feuer auf diese Positionen, sobald rote Infanterie aufgeklärt wird.
