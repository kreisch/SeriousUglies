...
do
  ...
  function AddDismounts(UnitName, dm_type, uflag) --Options for dm_type: "MANPADS", "Mortar", "Rifle", "ZU-23"
    for n = 1, #DismountsCarrier do
      if DismountsCarrier[n].name == UnitName then
        env.info("AddDismounts: " .. UnitName .. " is already registered.")
        return
      end
    end
...
--      env.info("Dismounts Checking: " .. DismountsCarrier[n].name)

      if u ~= nil then
--        env.info("Unit OK: " .. DismountsCarrier[n].name)

        local v = u:getVelocity() --Velocity is a Vec3
--        env.info("Unit speed: v.x: " .. v.x .. ",v.y: " .. v.y .. ",v.z: " .. v.z)

        if v.x < 0.00001 and v.y < 0.00001 and v.z < 0.00001 and
           v.x < -0.00001 and v.y < -0.00001 and v.z < -0.00001 then  --Check if speed is zero
          env.info("Unit Stopped: " .. DismountsCarrier[n].name)
          ...
          env.info("Unit Moving: " .. DismountsCarrier[n].name)
