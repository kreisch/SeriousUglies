...
ctld.pickupZones = {
    ...
    { "Naval-1-1", "none", -1, "yes", 0 },
    { "Naval-1-5", "none", -1, "yes", 0 },
    { "Naval-1-2", "none", -1, "yes", 0 },
    { "Naval-1-3", "none", -1, "yes", 0 },
    { "Naval-1-4", "none", -1, "yes", 0 }, -- instead of a Zone Name you can also use the UNIT NAME of a ship
}
...
ctld.wpZones = {
    ...
    { "Camp-Outpost", "none","yes", 0 },
    { "EWR-Outpost1", "none","yes", 0 },
    { "CityCamp1", "none","yes", 0 },
    { "Harbour1", "none","yes", 0 },
...
ctld.unitActions = {
    ...
    -- Remove the -- below to turn on options
    ["SA342Mistral"] = {crates=false, troops=false},
