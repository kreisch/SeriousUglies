...
local function SpawnSamSites(configuration)
...
local MenuCoalitionBlueSamSiteControlActivate = MENU_COALITION_COMMAND:New(coalition.side.BLUE, "Spawn SAMs North",
    MenuCoalitionBlueSamSiteControl, SpawnSamSites, {2, 1})
local MenuCoalitionBlueSamSiteControlActivate = MENU_COALITION_COMMAND:New(coalition.side.BLUE, "Spawn SAMs South",
    MenuCoalitionBlueSamSiteControl, SpawnSamSites, {2, 2})
local MenuCoalitionBlueSamSiteControlDeactive = MENU_COALITION_COMMAND:New(coalition.side.BLUE, "Despawn ALL SAMs",
    MenuCoalitionBlueSamSiteControl, DeSpawnSamSites)
