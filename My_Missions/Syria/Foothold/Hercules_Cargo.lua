	...
	local Herc_Soldier_Spawn = 
	{
		...
		["units"] = 
		{
			[1] = 
			{
				...
				["name"] = "Herc_Drop_Soldier Unit "..SoldierUnitID,
		...
		["name"] = "Herc_Drop_Soldier_Group_"..SoldierGroupID,
		["start_time"] = 0,
	}
	...
	local Herc_Cargo_Spawn = 
	{
		...
		["units"] = 
		{
			[1] = 
			{
				...
				["y"] = Cargo_Drop_Position.z,
				["x"] = Cargo_Drop_Position.x,
				["name"] = "Herc_Drop_Cargo Unit "..CargoUnitID,
				["heading"] = CargoHeading,
				["playerCanDrive"] = true,
			}, -- end of [1]
		}, -- end of ["units"]
		["y"] = Cargo_Drop_Position.z,
		["x"] = Cargo_Drop_Position.x,
		["name"] = "Herc_Drop_Cargo Group "..CargoUnitID,
		["start_time"] = 0,
	}
...
function Hercules_Cargo.Cargo_SpawnStatic(Cargo_Drop_Position, Cargo_Type_name, CargoHeading, dead, Cargo_Country)
	...
	local Herc_CargoObject_Spawn = 
	{
		...
		["y"] = Cargo_Drop_Position.z,
		["x"] = Cargo_Drop_Position.x,
		["name"] = "Herc_Drop_Cargo Static Group "..CargoStaticGroupID,
		["heading"] = CargoHeading,
		["dead"] = dead,
	}
