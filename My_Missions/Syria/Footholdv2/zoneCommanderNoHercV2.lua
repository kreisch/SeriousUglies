...
do
	...
	function CustomZone:spawnGroup(grname, forceFirst)
		...
		local spawnzone = nil
		local grpname = grname .. spawnCounterGroups
		spawnCounterGroups = spawnCounterGroups + 1
		--env.info("SPAWNING grname is: " .. grname .. " renaming to " .. grpname)
...
do
	...
	function ZoneCommander:capture(newside)
		if self.active and self.side == 0 and newside ~= 0 then
			...
			-- local zone = ZONE:FindByName(self.zone)
