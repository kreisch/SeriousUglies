...
redIADS:getSAMSites():setAutonomousBehaviour(SkynetIADSAbstractRadarElement.AUTONOMOUS_STATE_DARK)
redIADS:getEarlyWarningRadars():addPowerSource(comPowerSource)
redIADS:getSAMSiteByGroupName("GD_SAM_IADS_Minab_SA6"):addPowerSource(StaticObject.getByName("RU_IADS_MINAB_PowerPlant"))
...
A2ADispatcher:SetSquadronGrouping( "BandarAbbas", 2 ):SetDefaultCapLimit(2)
