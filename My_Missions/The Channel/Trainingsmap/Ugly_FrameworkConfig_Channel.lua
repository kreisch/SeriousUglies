...
Ugly.MissionSuffix = "Channel247"  -- A name suffix used, so different missions can use the same persistence directory

-- The intervall in which the live map JSON data is exported
Ugly.ExportMapInterval = 5
Ugly.LiveMapBaseDirectory = "C:\\DCS-WebMap\\Serious Uglies\\02 Maps Missions Server\\98 Server Admin\\Channel-Livemap\\"
