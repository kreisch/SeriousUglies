...
local function A2A_Easy_MenuStart()
	if allow_air_mission_stacking == false and A2A_Easy_Spawn ~= nil and A2A_Easy_Spawn:IsAlive() then
...
local function A2A_Normal_MenuStart()
	if allow_air_mission_stacking == false and A2A_Norm_Spawn ~= nil and A2A_Norm_Spawn:IsAlive() then
		trigger.action.outText( "<< There is already an A2A mission of this type currently active. >>\n \nYou can only spawn one of each A2A mission type at a time.\n \nPlease complete this mission type before spawning a new one.", 10)
		trigger.action.outSound("TTI Soundfiles/BD_00006 back square.ogg" )
	else
...
local function A2A_Hard_MenuStart()
		if allow_air_mission_stacking == false and A2A_Hard_Spawn ~= nil and A2A_Hard_Spawn:IsAlive() then
		trigger.action.outText( "<< There is already an A2A mission of this type currently active. >>\n \nYou can only spawn one of each A2A mission type at a time.\n \nPlease complete this mission type before spawning a new one.", 10)
		trigger.action.outSound("TTI Soundfiles/BD_00006 back square.ogg" )
	else
...
local function A2A_ALL_MenuStart() --107thonly
	if allow_air_mission_stacking == false and A2A_All_Spawn ~= nil and A2A_All_Spawn:IsAlive() then
		trigger.action.outText( "<< There is already an A2A mission of this type currently active. >>\n \nYou can only spawn one of each A2A mission type at a time.\n \nPlease complete this mission type before spawning a new one.", 10)
		trigger.action.outSound("TTI Soundfiles/BD_00006 back square.ogg" )
	else
...
local function A2A_BOMBING_MenuStart() --107thonly
	if allow_air_mission_stacking == false and A2A_BOMBING_1 ~= nil and A2A_BOMBING_1:IsAlive() then
		trigger.action.outText( "<< There is already an A2A mission of this type currently active. >>\n \nYou can only spawn one of each A2A mission type at a time.\n \nPlease complete this mission type before spawning a new one.", 10)
		trigger.action.outSound("TTI Soundfiles/BD_00006 back square.ogg" )
	else
...
local function A2A_HELO_MenuStart() --107thonly
	if allow_air_mission_stacking == false and A2A_Helo_Spawn ~= nil and A2A_Helo_Spawn:IsAlive() then
		trigger.action.outText( "<< There is already an A2A mission of this type currently active. >>\n \nYou can only spawn one of each A2A mission type at a time.\n \nPlease complete this mission type before spawning a new one.", 10)
		trigger.action.outSound("TTI Soundfiles/BD_00006 back square.ogg" )
	else
