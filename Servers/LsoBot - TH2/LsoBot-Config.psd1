...
@{
    ...
    webHookUrl  = 'https://discord.com/api/webhooks/862237691349565441/SAGhc3IauxWsDDa3tqIHxvPd0GxWS1Dkb2p4v4Tr2HnzT5wuVd4BBbaVLxQcVcLus2Y4'

    logpath     = '$env:USERPROFILE\Saved Games\DCS.closedbeta_server\Logs\dcs.log'
