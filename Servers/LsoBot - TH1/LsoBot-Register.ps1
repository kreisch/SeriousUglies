...
$logX = "\Logs\lsobot-debug-TH1.txt"
...
try {
    Register-ScheduledJob -Name "LSO Check TH1" -FilePath $lsoBotfilePath -ScheduledJobOption $O -Trigger $T -RunNow -ArgumentList @($LsoScriptRoot,$repetitionInterval)
